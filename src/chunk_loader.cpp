...
static CubeFace vd_data_solid[] = {
    ...
    {0.5f * BLOCK_SCALE, 1.0f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_TOP, CORNER_OFFSET_tcc},    // 24
    {0.5f * BLOCK_SCALE, 0.0f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_BOTTOM, CORNER_OFFSET_bcc}, // 25
    {1.0f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_RIGHT, CORNER_OFFSET_ccr},  // 26
    {0.5f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, 1.0f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_FRONT, CORNER_OFFSET_cfc},  // 27
    {0.0f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_LEFT, CORNER_OFFSET_ccl},   // 28
    {0.5f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, 0.0f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_BACK, CORNER_OFFSET_cbc},   // 29
