...
static CubeFace vd_data_selection[] = {
    ...
    {0.5f * BLOCK_SCALE, 1.0f + SELECTION_SIZE_OFFSET, 0.5f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_TOP, CORNER_OFFSET_c},    // 24
    {0.5f * BLOCK_SCALE, 0.0f - SELECTION_SIZE_OFFSET, 0.5f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_BOTTOM, CORNER_OFFSET_c}, // 25
    {1.0f + SELECTION_SIZE_OFFSET, 0.5f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_RIGHT, CORNER_OFFSET_c},  // 26
    {0.5f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, 1.0f + SELECTION_SIZE_OFFSET, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_FRONT, CORNER_OFFSET_c},  // 27
    {0.0f - SELECTION_SIZE_OFFSET, 0.5f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_LEFT, CORNER_OFFSET_c},   // 28
    {0.5f * BLOCK_SCALE, 0.5f * BLOCK_SCALE, 0.0f - SELECTION_SIZE_OFFSET, /*Coords  Texture coords*/ 0.5f, 0.5f, FACE_BACK, CORNER_OFFSET_c},   // 29
};
