...
typedef enum {
    ...
    GLASS_BLUE = 362,
    GLASS_BROWN = 363,
    GLASS_LIGHT_BLUE = 364,
    GLASS_GRAY = 365,
    GLASS_DARK_GREEN = 366,
    GLASS_LIGHT_GREEN = 367,
    GLASS_TINT_GREEN = 368,
    GLASS_PALE_BLUE = 369,
    GLASS_WHITE = 370,
    END_ROD = 376,
    ...
    REDSTONE_TORCH_TOP = 1232,
    REDSTONE_TORCH_OFF_TOP = 1233,
    REDSTONE_TORCH_BOTTOM = 1234,
