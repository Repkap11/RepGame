#WASM
MAKEFILES += wasm.mk
CFLAGS_WASM := $(CFLAGS) -DREPGAME_WASM -s ALLOW_MEMORY_GROWTH=1 -s NO_EXIT_RUNTIME=1
...
out/wasm/$(TARGET).js: $(OBJECTS_COMMON_WASM) $(OBJECTS_WASM) $(MAKEFILES)
	$(CC_WASM) -flto $(CFLAGS_WASM) $(OBJECTS_WASM) $(OBJECTS_COMMON_WASM) -o $@

wasm-start-server:
	http-server &

wasm-run: wasm
	google-chrome --new-window http://localhost:8080/src/wasm/index.html
