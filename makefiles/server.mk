...
OBJECTS_SERVER = $(patsubst src/server/%.cpp,out/server/%.o, $(wildcard src/server/*.cpp) out/linux/release/common/utils/file_utils.o out/linux/release/common/utils/map_storage.o)
