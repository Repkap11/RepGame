...
OBJECTS_SERVER = $(patsubst src/server/%.cpp,out/server/%.o, $(wildcard src/server/*.cpp) out/linux/debug/common/utils/file_utils.o out/linux/debug/common/utils/map_storage.o out/linux/debug/common/net/packet.o out/linux/debug/common/net/framed_socket.o)
