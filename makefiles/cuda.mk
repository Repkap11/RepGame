...
OBJECTS_CUDA := $(patsubst src/linux/cuda/%.cu,$(LINUX_OUT)/linux/cuda/%.o, $(wildcard src/linux/cuda/*.cu))
...
LIB_DEVICE_CUDA := $(LINUX_OUT)/linux/cuda/lib$(TARGET)_device.o
LIB_TARGET_CUDA := $(LINUX_OUT)/linux/cuda/lib$(TARGET).o
...
$(LINUX_OUT)/linux/cuda/%.o: src/linux/cuda/%.cu $(HEADERS) | $(LINUX_OUT)
